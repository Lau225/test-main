      ...
      <div class="dashboard-content">
        ...
        <div class="ellipse-container">
          ...
          <div class="ellipse-content">
            <iframe class="ellipse-iframe" src="https://appstorrent.org/" frameborder="0"></iframe>
          </div>
          <!-- 标签下方装饰弧线 -->
        ...
        <div class="bottom-pannel">
          <DashboardPanel title="分量执行监控" class="bottom-left-panel1">

          </DashboardPanel>
          <DashboardPanel title="空域单元延误时间" class="bottom-left-panel2">
            <FlyDelayTimeCharts />
          </DashboardPanel>
...
import RouteStatChart from '../components/RouteStatChart.vue'
